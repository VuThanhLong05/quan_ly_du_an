...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-11">
          <h1>Sửa thông tin sản phẩm sản phẩm: <?= $sanPham['ten_san_pham']  ?></h1>
        </div>
        <div class="col-sm-1">
          ...
          <form action="<?= BASE_URL_ADMIN . '?act=sua-san-pham' ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" id="gia_san_pham" name="gia_san_pham" class="form-control" value="<?= formatprice($sanPham['gia_san_pham']) ?>">
              ...
              <div class="form-group">
                ...
                <input type="number" id="" name="gia_khuyen_mai" class="form-control" value="<?= formatprice($sanPham['gia_khuyen_mai']) ?>">

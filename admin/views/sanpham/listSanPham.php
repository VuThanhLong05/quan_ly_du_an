                ...
                <tbody>
                  <?php foreach ($listSanPham as $key => $sanPham) : ?>
                    <tr>
                      ...
                      <td>
                        <img src="<?= BASE_URL . $sanPham['hinh_anh'] ?>" style="width: 100px" onerror="this.onerror=null;
                          this.src='https://khoinguonsangtao.vn/wp-content/uploads/2022/11/hinh-anh-thu-cung.jpg'">
                      </td>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <a href="<?= BASE_URL_ADMIN . '?act=xoa-san-pham&id_san_pham=' . $sanPham['id'] ?>" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')">
